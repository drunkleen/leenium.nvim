...
function M.setup(c, theme)
  ...
  local groups = {
    ...
    NvimTreeOpenedFolderIcon = { fg = c.cyan },
    ...
    lualine_a_normal = { fg = c.bg, bg = c.type, bold = true },
    lualine_a_insert = { fg = c.bg, bg = c.error_soft, bold = true },
    lualine_a_visual = { fg = c.bg, bg = c.cyan, bold = true },
